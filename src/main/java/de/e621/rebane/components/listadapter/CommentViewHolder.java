...
public class CommentViewHolder {
    ...
    public void populate(int position, View element, final XMLNode data) {
        ...
        final String UserID = data.getFirstChildContent("creator_id").orElse("");
        ...
        if (author == null && !requestRunningFor.contains(UserID) && MiscStatics.canRequest(context)) {
            author = new AuthorData(data.getFirstChildContent("creator").orElse(""), Integer.valueOf(UserID), 0, -100);
        ...
        String info = MiscStatics.readableTime(data.getFirstChildContent("created_at").orElse("")) + "\n#" + data.getFirstChildContent("id").orElse("");
        txtInfo.setText(info);

        int score = Integer.valueOf(data.getFirstChildContent("score").orElse(""));
        txtScore.setText(data.getFirstChildContent("score").orElse(""));
        if (score > 0)
